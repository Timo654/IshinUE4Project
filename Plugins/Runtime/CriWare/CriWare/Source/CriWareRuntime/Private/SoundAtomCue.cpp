...
void USoundAtomCue::SetAssetUserDataInteger64(int64 Value) {
}

void USoundAtomCue::RemoveAllAssetUserData() {
}
...
void USoundAtomCue::AddAssetUserDataInteger64(int64 Value) {
}
