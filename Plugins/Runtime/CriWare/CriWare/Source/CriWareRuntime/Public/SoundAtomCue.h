...
class CRIWARERUNTIME_API USoundAtomCue : public UObject, public IInterface_AssetUserData {
    GENERATED_BODY()
public:
...
public:
    ...
    void SetAssetUserDataInteger64(int64 Value);
    
    UFUNCTION(BlueprintCallable)
    void RemoveAllAssetUserData();
    ...
    UFUNCTION(BlueprintCallable)
    void AddAssetUserDataInteger64(int64 Value);
